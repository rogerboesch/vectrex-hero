...
void app_export_c(App *app) {
    ...
    fprintf(fc, "};\n");
    fclose(fc); fclose(fh);
    app_log_info(app, "Exported %d tiles to tileset_export", app->tmap.tileset.used_count);

    /* Export levels to levels_export.c/h */
    ...
    fprintf(fc, "/* levels_export.c — Generated by GBC Workbench */\n");
    fprintf(fc, "#include \"levels_export.h\"\n\n");
    fprintf(fh, "/* levels_export.h — Generated by GBC Workbench */\n");
    ...
    fprintf(fh, "\n#endif\n");
    fclose(fc); fclose(fh);
    app_log_info(app, "Exported %d levels", app->tmap.level_count);
