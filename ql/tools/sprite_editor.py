...
class SpriteEditor:
    ...
    def _build_ui(self):
        ...
        editmenu.add_command(label="Flip Vertical", command=self._flip_v)
        editmenu.add_separator()
        editmenu.add_command(label="Move Up", command=self._move_up)
        editmenu.add_command(label="Move Down", command=self._move_down)
        editmenu.add_command(label="Move Left", command=self._move_left)
        editmenu.add_command(label="Move Right", command=self._move_right)
        editmenu.add_separator()
    ...
    def _write_c_files(self, directory):
        c_lines = [
            ...
            "/* Generated by QL Studio (sprite_editor.py) */", "",
            '#include "sprites.h"', "",
        ]
        h_lines = [
