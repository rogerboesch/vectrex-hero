/*
 * levels.c -- Level management and room data loading (Apple II port)
 *
 * Direct port from ql/src/levels.c. Reuses level data from the
 * Vectrex version (../../vectrex/src/levels.h).
 */
