/*
 * enemies.c -- Enemy AI, laser, dynamite, miner rescue (Apple II port)
 *
 * Direct port from ql/src/enemies.c. Logic is identical; only the
 * header include differs. All timing constants come from game.h,
 * scaled for ~10 FPS.
 */
