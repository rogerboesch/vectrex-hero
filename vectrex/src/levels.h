...
// Row combo [0, 0, 0]
static const int8_t cave_r0_0_0[] = {
    9, -40, -125, 0, 25, 30, 0, 0, -25, 0, 25, 30,
    0, 0, -25, 0, 25, 30, 0, 0, -25, 9, 50, 125,
    0, -25, -30, 0, 0, 25, 0, -25, -30, 0, 0, 25,
    0, -25, -30, 0, 0, 25, 0,
};
...
#define L11R16_MINER_X  -89
#define L11R16_MINER_Y  -4

// Room lookup tables for level 11
static const int8_t * const l11_room_caves[] = {
    cave_r6_0_5,    // room 0 rows [6, 0, 5]
    cave_r0_0_0,    // room 1 rows [0, 0, 0]
    cave_r0_0_0,    // room 2 rows [0, 0, 0]
    cave_r0_0_0,    // room 3 rows [0, 0, 0]
    cave_r0_0_0,    // room 4 rows [0, 0, 0]
    cave_r0_0_0,    // room 5 rows [0, 0, 0]
    cave_r0_0_0,    // room 6 rows [0, 0, 0]
    cave_r0_0_0,    // room 7 rows [0, 0, 0]
    cave_r0_0_0,    // room 8 rows [0, 0, 0]
    cave_r0_0_0,    // room 9 rows [0, 0, 0]
    cave_r0_0_0,    // room 10 rows [0, 0, 0]
    cave_r0_0_0,    // room 11 rows [0, 0, 0]
    cave_r0_0_0,    // room 12 rows [0, 0, 0]
    cave_r0_0_0,    // room 13 rows [0, 0, 0]
    cave_r0_0_0,    // room 14 rows [0, 0, 0]
    cave_r0_0_0,    // room 15 rows [0, 0, 0]
};
...
#define L12R16_MINER_X  -89
#define L12R16_MINER_Y  -4
...
#define L13R16_MINER_X  -89
#define L13R16_MINER_Y  -4
...
#define L14R16_MINER_X  -89
#define L14R16_MINER_Y  -4
...
#define L15R16_MINER_X  -89
#define L15R16_MINER_Y  -4
...
#define L16R16_MINER_X  -89
#define L16R16_MINER_Y  -4
...
#define L17R16_MINER_X  -89
#define L17R16_MINER_Y  -4
...
#define L18R16_MINER_X  -89
#define L18R16_MINER_Y  -4
...
#define L19R16_MINER_X  -89
#define L19R16_MINER_Y  -4
...
#define L20R16_MINER_X  -89
#define L20R16_MINER_Y  -4
